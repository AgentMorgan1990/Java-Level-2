...
public class Robot implements Ability, OvercomeTheBoundary {
    ...
    public boolean isPassedBoundary() {
        ...
        return this.passedBoundary;
    }

    public Robot(int runningLength, int jumpHeight, String name) {
        this.runningLength = runningLength;
        this.jumpHeight = jumpHeight;
        this.name = name;
    ...
    public void overcomeTheBoundary(Boundary boundary) {
        if (passedBoundary == false) {
            System.out.println("Снят с дистанции");
        } else {
